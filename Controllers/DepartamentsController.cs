...
namespace SalesWebMVC.Controllers
{
    public class DepartamentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome")] Departaments departaments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome")] Departaments departaments)
        {
